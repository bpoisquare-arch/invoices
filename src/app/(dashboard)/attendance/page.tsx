          ...
          <form onSubmit={handleUpdateEmployee} className="flex-1 overflow-y-auto p-4 sm:p-5 space-y-3.5">
            ...
            <div className="bg-slate-50 border border-slate-200/90 rounded-xl p-3 space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span className="px-2 py-0.5 rounded bg-amber-100 text-amber-800 text-[10px] font-bold flex items-center gap-1 border border-amber-200">
              ...
              <div className={`grid grid-cols-2 ${!showEditProbation ? 'sm:grid-cols-2' : 'sm:grid-cols-3'} gap-2`}>
                <div className="space-y-1 bg-slate-100/80 p-2 rounded-lg border border-slate-200">
                  <Label className="text-[10px] font-bold text-slate-500 uppercase">Annual</Label>
                  <Input
                    type="number"
                    disabled
                    readOnly
                ...
                <div className="space-y-1 bg-slate-100/80 p-2 rounded-lg border border-slate-200">
                  <Label className="text-[10px] font-bold text-slate-500 uppercase">Sick</Label>
                  <Input
                    type="number"
                    disabled
                    readOnly
                ...
                <div className="space-y-1 bg-slate-100/80 p-2 rounded-lg border border-slate-200">
                  <Label className="text-[10px] font-bold text-slate-500 uppercase">Casual</Label>
                  <Input
                    type="number"
                    disabled
                    readOnly
                ...
                <div className="space-y-1 bg-slate-100/80 p-2 rounded-lg border border-slate-200">
                  <Label className="text-[10px] font-bold text-slate-500 uppercase">WFH</Label>
                  <Input
                    type="number"
                    disabled
                    readOnly
                ...
                {showEditProbation && (
                  <div className="space-y-1 bg-slate-100/80 p-2 rounded-lg border border-slate-200">
                    <Label className="text-[10px] font-bold text-slate-500 uppercase">Probation</Label>
                    <Input
                      type="number"
                      disabled
                      readOnly
