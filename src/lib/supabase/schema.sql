...
CREATE TABLE IF NOT EXISTS public.aimt_payslips (
    ...
    superannuation_description VARCHAR(255) DEFAULT '',
    superannuation_amount NUMERIC(12, 2) NOT NULL DEFAULT 0.00,
    superannuation_total NUMERIC(12, 2) NOT NULL DEFAULT 0.00,
...
-- 18. STC REPORT IMPORTS TABLE (States College Australia)
...
-- 19. STC REPORT RECORDS TABLE (States College Australia)
